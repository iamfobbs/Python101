...
#print "Test case 1: ", fix_machine('UdaciousUdacitee', 'Udacity') == "Give me something 
#that's not useless next time."
...
## NOTES
# finds string in a string using a built in function!

#fix_machine('UdaciousUdacitee', 'Uda')    
